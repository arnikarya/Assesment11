       ...
       public static void TeenagerStudents()
        {
             List<Students> studentList = new List<Students>()
              {
                 new Students(){Id=1,Name="Aryan",Age=20},
                  new Students(){Id=2,Name="Kumar",Age=18},
                   new Students(){Id=3,Name="Rahul",Age=17},
                    new Students(){Id=4,Name="Nikhil",Age=23},
                     new Students(){Id=5,Name="Mayank",Age=30},
                      new Students(){Id=6,Name="Kartik",Age=13},
                       new Students(){Id=7,Name="Bumrah",Age=12}
